 ...
 **/
public class MqttClientConsumerTest2 {
...
//      connOpts.setServerURIs(uris);  //起到负载均衡和高可用的作用
        ...
        mqttClient.setCallback(new PushCallback("test2"));
...
//        }
    ...
    public static void main(String[] args) throws MqttException {
        sub("message content","client-id-2","/t1/t3");
    }
}
...
class PushCallback2 implements MqttCallback {
    ...
    public PushCallback2(String threadId){
